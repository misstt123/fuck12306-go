...
func GetHuiJia() {
	...
	for {
		...
		url := "https://kyfw....cn/otn/leftTicket/query?leftTicketDTO.train_date=" + yd.Traindate + "&leftTicketDTO.from_station=" + yd.From + "&leftTicketDTO.to_station=" + yd.To + "&purpose_codes=ADULT"
		method := "GET"
		client := &http.Client{}
...
func IsLogin() {
	...
	for {
		...
		var c config.Config
		c.GetConf()
		url := "https://kyfw....cn/otn/login/checkUser"
		method := "GET"
